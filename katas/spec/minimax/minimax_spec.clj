...
(describe "Minimax"
		...
		(it "scores boxes"
				(should= 0 (find-best-score ["X" "O" "X" 3 "O" "O" "O" "X" "X"] -1 0))
				(should= 0 (find-best-score ["X" "O" "X" 3 "O" 5 "O" "X" "X"] 1 0))
				(should= 0 (find-best-score ["X" "O" 2 3 "O" 5 "O" "X" "X"] -1 0))
				(should= 0 (find-best-score ["X" "O" 2 3 "O" 5 6 "X" "X"] 1 0))
				(should= 0 (find-best-score ["X" "O" 2 3 "O" 5 6 7 "X"] -1 0))
				(should= 0 (find-best-score ["X" 1 2 3 "O" 5 6 7 "X"] 1 0))
				(should= 0 (find-best-score ["X" 1 2 3 "O" 5 6 7 8] -1 0))
				(should= 0 (find-best-score ["X" 1 2 3 4 5 6 7 8] 1 0))
				(should= 9 (find-best-score ["X" "X" 2 "O" "O" "X" 6 "O" "O"] -1 0))
				)
		...
		(it "finds best box"
				...
				(should= 2 (find-best-box ["X" "X" 2 "O" "O" "X" 6 "O" "O"] 1))
				)
		)
